...
export function ProjectUniverseScene() {
  ...
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center px-4 overflow-hidden pointer-events-auto">
      ...
      >
        <div className="absolute inset-4 rounded-full shadow-[0_0_60px_rgba(234,179,8,0.3)] group-hover:shadow-[0_0_100px_rgba(234,179,8,0.5)] transition-shadow duration-500" />
        <div className="w-full h-full bg-[url('/assets/worlds/bookhub/bookhub.png')] bg-contain bg-center bg-no-repeat animate-[float_6s_ease-in-out_infinite]" />
        ...
        <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div className="flex items-center gap-2 text-yellow-400 font-mono text-sm tracking-widest bg-black/50 px-4 py-2 rounded-full border border-yellow-500/30 backdrop-blur-md">
      ...
      <div className="absolute top-32 md:top-40 flex flex-col items-center pointer-events-none">
        ...
        <p className="font-mono text-yellow-400/80 tracking-[0.3em] uppercase mt-2">
          Global Literary Ecosystem
        </p>
      </div>
          ...
          >
            ...
            <div className="p-6 border-b border-white/10 flex justify-between items-center bg-yellow-500/5">
              <div className="flex flex-col">
                <span className="font-mono text-xs text-yellow-500 tracking-[0.2em]">MISSION DOSSIER</span>
                <h3 className="font-heading text-2xl text-white font-bold">BookHub Architecture</h3>
              </div>
              <button 
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-10 custom-scrollbar">
              ...
              <section>
                ...
                <p className="text-white font-sans leading-relaxed text-lg">
                  To build a comprehensive digital ecosystem that connects readers, authors, and publishers. The platform needed to handle massive concurrent read operations while ensuring secure transaction processing for literary purchases.
                </p>
              </section>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <GlassCard className="p-4 flex items-center gap-3 bg-white/5">
                    ...
                    <div>
                      ...
                      <div className="text-white text-xs font-mono">Backend</div>
                    </div>
                  </GlassCard>
                  <GlassCard className="p-4 flex items-center gap-3 bg-white/5">
                ...
                <ul className="space-y-4">
                  <li className="flex gap-3">
                    ...
                    <p className="text-white/90 font-sans">
                      <strong className="text-white">Real-time Search:</strong> Implemented indexed text-search across a collection of 50,000+ books with sub-100ms response times.
                    </p>
                  </li>
                  <li className="flex gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-yellow-500 mt-2 shrink-0" />
                    <p className="text-white/90 font-sans">
                      <strong className="text-white">Secure Authentication:</strong> Built a custom JWT-based stateless authentication flow for scalable session management.
                    </p>
                  </li>
                </ul>
              </section>
            ...
            <div className="p-6 border-t border-white/10 bg-black/40">
              <a href="https://book-hub-khaki.vercel.app/" target="_blank" rel="noopener noreferrer">
                <Button className="w-full bg-yellow-500 hover:bg-yellow-400 text-black font-bold flex items-center justify-center gap-2">
